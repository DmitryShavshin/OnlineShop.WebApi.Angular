...
namespace OnlineShop.WebApi.Angular.Migrations
{
    ...
    [Migration("20221110155228_UpdateUserModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "96a16759-a244-413d-9910-34723ca9f8c0",
                            Name = "admin",
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Age = 0,
                            ConcurrencyStamp = "f0f9e67b-3e8c-4b80-b5eb-23c86525eaba",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEF4N78Ky9EQiQhOBpBftKPZN6l5aWDHXdzrzQoW7G+Bg3HgB9R+IDDUEvufoujLk0g==",
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.UserContact", b =>
                {
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.UserHomeAddress", b =>
                {
                    ...
                    b.ToTable("UserHomeAddress");
                });

            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.UserWorkAddress", b =>
                {
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.UserContact", b =>
                {
                    b.HasOne("OnlineShop.WebApi.Angular.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("UserContact")
                        .HasForeignKey("OnlineShop.WebApi.Angular.Models.UserContact", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.UserHomeAddress", b =>
                {
                    b.HasOne("OnlineShop.WebApi.Angular.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("HomeAddress")
                        .HasForeignKey("OnlineShop.WebApi.Angular.Models.UserHomeAddress", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineShop.WebApi.Angular.Models.UserWorkAddress", b =>
                {
                    b.HasOne("OnlineShop.WebApi.Angular.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("WorkAddress")
                        .HasForeignKey("OnlineShop.WebApi.Angular.Models.UserWorkAddress", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
